...
production; both manifests have a real `icon-512.png` (generated by upscaling a leftover,
higher-resolution 310px asset already sitting unused in the same icons folder, rather than a
design tool this fix doesn't have access to); and CNPJ validation now supports Receita Federal's
alphanumeric CNPJs
